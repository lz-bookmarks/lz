...
#[derive(Serialize, Debug, ToSchema, ToResponse, Clone, PartialEq, Eq)]
...
/// Annotate bookmarks with their associated links and tags, then
/// return those annotated bookmarks and the next cursor.
